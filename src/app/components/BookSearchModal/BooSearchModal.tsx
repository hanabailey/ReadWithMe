...
interface BookSearchModalProps {
  ...
  return (
    ...
    {img[selectedImageIndex] && <img src={img[selectedImageIndex]} className={styles.img} />}
    {selectedBookInfo && (
        <div className={styles.content}>
          ...
          <ScrollArea h={250} scrollHideDelay={500}>
            <p className={styles.bookDescription}>{selectedBookInfo.description}</p>
          </ScrollArea>
          ...
          <button onClick={closeBookDetailModal} className={styles.Button}>Close</button>
